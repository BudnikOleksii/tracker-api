...
> = {
  ...
  meta: {
    modelProps: 'user' | 'refreshToken' | 'category' | 'transaction';
 ...
 */
export type EnumCurrencyCodeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'CurrencyCode'
>;
 ...
 * Reference to a field of type 'CurrencyCode[]'
 */
export type ListEnumCurrencyCodeFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'CurrencyCode[]'
>;
